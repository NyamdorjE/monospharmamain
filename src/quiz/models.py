...
class Progress(models.Model):
    ...
    user = models.OneToOneField(
        settings.AUTH_USER_MODEL, verbose_name=_("Хэрэглэгч"), on_delete=models.CASCADE
    )
    ...
    correct_answer = models.CharField(max_length=10, verbose_name=_("Зөв хариулт"))

    wrong_answer = models.CharField(max_length=10, verbose_name=_("Буруу хариулт"))

    objects = ProgressManager()

    class Meta:
        verbose_name = _("Хэрэглэгчийн оноо")
        verbose_name_plural = _("Хэрэглэгчийн оноо")
